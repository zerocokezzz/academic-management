...
@Getter
@ToString
public class LessonPageResponseDTO<E> {
    ...
    @Builder(builderMethodName = "withState")
    public LessonPageResponseDTO(LessonPageRequestDTO pageRequestDTO, List<E> dtoList, int total) {
